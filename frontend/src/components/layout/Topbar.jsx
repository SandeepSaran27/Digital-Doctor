        ...
        >
            ...
            {user?.role === 'patient' && (
                <button
                    ...
                    className="btn-primary text-xs py-1.5 px-3 whitespace-nowrap hidden sm:flex shadow-sm shadow-indigo-500/30"
                >
                    + Book Appointment
                </button>
            )}

            <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 rounded-xl p-0.5 ml-2">
                {LANGS.map((l) => (
                    <button
                        key={l.code}
                        onClick={() => changeLang(l.code)}
